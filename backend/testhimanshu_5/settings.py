"""
Django settings for testhimanshu_5 project.
...
ROOT_URLCONF = 'testhimanshu_5.urls'
...
WSGI_APPLICATION = 'testhimanshu_5.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testhimanshu_5 API",
    "DESCRIPTION": "API documentation for testhimanshu_5 App",
    "VERSION": "v1",
}
